  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        {/***************************************************** *  */}
            ...
            <div className="lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24 ">
                <div className="lg:col-span-2 ">
                    ...
                    <h1 className='text-lg lg:text-xl text-gray-900 opacity-50 pt-1'> Casual T-Shirts for men </h1>
                </div>
                ...
                <div className="mt-4 lg:row-span-3 lg:mt-0">
                    ...
                    <div className="mt-6">
                        <div className='flex items-center space-x-3'>
                            ...
                            <p className='opacity-50 text-sm'>15348 Ratings</p>
                            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>342 Reviews</p>
                        </div>
                    ...
                    <div className="mt-10">
                        <div className="flex items-center justify-between">
                            <h3 className="text-sm font-medium text-gray-900">Size</h3>
                                                                        {/* <a href="#" className="text-sm font-medium text-indigo-600 hover:text-indigo-500"> Size guide// </a>   to be implemented in future     */}
                        </div>
                    ...
                    <Button onClick={handleAddToCart} variant="contained" sx={{px:"2rem", py:"1rem ,bg-color: #9155fd"}}>
                        Add to Cart
                    </Button>
                    </form>
                </div>
        ...
        <section>
            <h1 className='font-semibold text-lg pb-5'>Review and Ratings</h1>
                    ...
                    <Grid item xs={5}>
                        ...
                        <Box className="mt-5 space-y-3">
                            ...
                            <Grid container alignItems="center" gap={2} > 
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor: "#d0d0d0", borderRadius:4, height:7, color: "#ffea00" }} variant='determinate' value={35} color='warning' />
                                </Grid>
                            </Grid>
        ...
        <section className='pt-10'>
            ...
            <div className='flex space-x-5' >
                {menskurta.map((items) => <HomeSectionCard product={items}/>).slice(0, 6)}
            </div>
        </section>
